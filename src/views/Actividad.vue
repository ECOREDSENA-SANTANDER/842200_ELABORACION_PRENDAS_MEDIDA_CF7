  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          .h4 Conceptos de Confección de prendas de vestir
        p.mb-4 Identificar la apropiación de los contenidos en la temática de Confección de prendas de vestir femeninas y masculinas.
