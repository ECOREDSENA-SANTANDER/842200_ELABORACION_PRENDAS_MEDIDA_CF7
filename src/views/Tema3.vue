...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    LineaTiempoC.color-acento-botones.bgimg-slider.p-5.mb-5(data-aos="zoom-in-left")
      .row(numero="1" titulo="Paso 1").lineac-cus
      ...
      .row(numero="2" titulo="Paso 2").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
            img(src='@/assets/curso/tema_3/img_18.png', alt='falda')
        .col-sm-12.col-lg-8
      ...
      .row(numero="3" titulo="Paso 3").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
            img(src='@/assets/curso/tema_3/img_19.png', alt='falda')
        .col-sm-12.col-lg-8
      ...
      .row(numero="4" titulo="Paso 4").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
            img(src='@/assets/curso/tema_3/img_20.png', alt='falda')
        .col-sm-12.col-lg-8
      ...
      .row(numero="5" titulo="Paso 5").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
            img(src='@/assets/curso/tema_3/img_21.png', alt='falda')
        .col-sm-12.col-lg-8
      ...
      .row(numero="6" titulo="Paso 6").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
            img(src='@/assets/curso/tema_3/img_22.png', alt='falda')
        .col-sm-12.col-lg-8
      ...
      .row(numero="7" titulo="Paso 7").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
            img(src='@/assets/curso/tema_3/img_23.png', alt='falda')
        .col-sm-12.col-lg-8
      ...
      .row(numero="9" titulo="Paso 9").lineac-cus
        .col-sm-12.col-lg-4.d-none.d-lg-block
