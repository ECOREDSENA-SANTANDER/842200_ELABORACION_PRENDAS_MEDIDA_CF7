  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal
      .titulo-principal__numero
        span 3
      h1 Confección de prendas masculinas
          ...
          .row.justify-content-center
            .col-lg-11
              ul.lista-ul--color
                li 
                  i.far.fa-dot-circle
                  p #[strong Embaste:] las capas de entretela y forro se cosen al revés de la tela con pequeñas puntadas diagonales llamadas embastes, que sujetan las tres telas y controlan la forma de las solapas y del cuello. 
                li 
                  i.far.fa-dot-circle
                  p #[strong Punto escapulario:] se usa para fijar las tiras a los bordes de una prenda de sastre. 
                li 
                  i.far.fa-dot-circle
                  p #[strong Preparación:] une todas las entretelas al cuerpo de la chaqueta y termina las costuras de los hombros.
      .col-lg-4
        figure
          img(src='@/assets/curso/tema_3/img_1.png', alt='Confección de prendas masculinas')
        ...
        LineaTiempoD.color-secundario
          ...
          .row.d-flex.p-4(numero="4" titulo="Ojalar en una máquina industrial")
            .col-lg-12
              figure
                .video
                  iframe(width="560" height="315" src="https://www.youtube.com/embed/2DybdDUrI0w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        ...
        .bloque-texto-a.color-secundario.p-4.p-md-5
          .row.m-0.align-items-center.justify-content-between
            .col-lg-4.mb-4.mb-lg-0
              .h3.mb-0 Orden operacional de confección masculina
            .col-lg-8
    ...
    p.mb-5 A continuación, se conocerá la ruta de orden operacional para una camisa:

    .row.justify-content-center.mb-5
      .col-lg-11
        LineaTiempoD.color-secundario
          .row.d-flex.p-4(numero="1" titulo="Preparación de cuellos")
            .col-lg-7
              ol.lista-ol
                li 
                  span.text-bold 1. 
            ...
            .col-lg-5
              figure
                img(src='@/assets/curso/tema_3/img_2.png', alt='falda')

          .row.d-flex.p-4(numero="2" titulo="Preparación de banda o pie de cuello")
            ol.lista-ol
              li 
                span.text-bold 1. 
          ...
          .row.d-flex.p-4(numero="3" titulo="Preparación de la pechera, extensión de botonadura o cruce")
            ol.lista-ol
              li 
                span.text-bold 1. 
          ...
          .row.d-flex.p-4(numero="4" titulo="Preparación y ensamble del bolsillo")
            ol.lista-ol
              li 
                span.text-bold 1. 
          ...
          .row.d-flex.p-4(numero="5" titulo="Preparación o ensamble de puño")
            ol.lista-ol
              li 
                span.text-bold 1. 
          ...
          .row.d-flex.p-4(numero="6" titulo="Preparación de espalda")
            ol.lista-ol
              li 
                span.text-bold 1. 
          ...
          .row.d-flex.p-4(numero="7" titulo="Preparación de portañuela")
            ol.lista-ol
              li 
                span.text-bold 1. 
          ...
          .row.justify-content-center.d-flex.p-4(numero="8" titulo="Confección blusa camisera")
            ...
            figure
              .video
                iframe(width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLkc5n6npRWkink2WtHYTQCrNkLrWX2L12" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)

          .row.justify-content-center.d-flex.p-4(numero="9" titulo="Confección camiseta tipo polo")
            ...
            figure
              .video
                iframe(width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLkc5n6npRWkjH9BnFJlUpDKgV0Zk3yhVe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)

    p.mb-5 A continuación, se conocerá la ruta de orden operacional para un pantalón:  

    .row.mb-5
      .col-lg-8
        PasosA.color-primario.mb-5(tipo="n")
          .row
            p Montaje de cierre, cremallera, corredera o zipper (aletilla y letillón).

          .row
            p Preparación de bolsillos.
      ...
      .col-lg-4
        figure
          img.img-a(src='@/assets/curso/tema_3/img_3.png', alt='falda')

    .tabla-b.color-acento-contenido.mb-5
      table
        thead
          tr.text-center
            td.h6.mb-0.table_th Preparación de las piezas
            td.h6.mb-0.table_th Proceso de plantillado fusionado y prehormado
        tbody
          tr
            td 
              ol.lista-ol
      ...
      .col-lg-11
        LineaTiempoD.color-secundario
          ...
          .row.d-flex.p-4(numero="2" titulo="Confección del pantalón para caballero")
            figure
              .video
                iframe(width="560" height="315" src="https://www.youtube.com/embed/NHtzg2UrKHs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
           
    p.mb-5 A continuación, en la tabla 2 se conocerá la ruta de orden operacional para prendas en tejido de punto.

    p.BorTit Tabla 2. Operaciones prendas de tejido
